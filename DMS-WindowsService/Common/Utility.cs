...
namespace DMS_WindowsService.Common
{
	class Utility
	{
		...
		public static string BigSizeDocuemnt = "Docuemnt is big size";

		#region Department Names
		public const string RSAD_DEPT_NAME = "Art, Culture and Archaeology Department";
        ...
        //public const string OD = "Other Department";
        public const string RORI = "Art, Culture and Archaeology Department";
        #endregion
        ...
        public const string COL_Field1 = "Field1";
        public const string COL_Accession_No = "Accession No";
        #endregion
